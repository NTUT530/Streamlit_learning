...
def example(color1, color2, color3, text1,text2):
     st.markdown(f'<p style="text-align:center;background-image: linear-gradient(to right,{color1}, {color2});color:{color3};font-size:35px;border-radius:20%;"><font face="微軟正黑體"><b>{text1}<br>{text2}</b></font></p>', unsafe_allow_html=True)
...
co1, co2, co3 ,co4 ,co5 ,co6 ,co7= st.beta_columns(7)
with co4:
