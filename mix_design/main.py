...
def example(color1, color2, color3, content):
     st.markdown(f'<p style="text-align:center;background-image: linear-gradient(to right,{color1}, {color2});color:{color3};font-size:30px;border-radius:30%;">{content}</p>', unsafe_allow_html=True)
