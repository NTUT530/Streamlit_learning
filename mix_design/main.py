...
def example(color1, color2, color3, text1,text2):
     st.markdown(f'<p style="text-align:center;background-image: linear-gradient(to right,{color1}, {color2});color:{color3};font-size:30px;border-radius:20%;"><b>{text1}<br>{text2}</b></p>', unsafe_allow_html=True)
