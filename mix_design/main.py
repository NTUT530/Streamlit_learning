...
Gc = st.sidebar.slider(min_value = 1.0,max_value=4.0,step = 0.01,value = 2.93,label=st.markdown("<h1 style='text-align: center; color: red;'>水泥</h1>", unsafe_allow_html=True) )
